...
public class MovieRestController {
    private final IMovieRestService m_movieService;

    public MovieRestController(IMovieRestService movieService)
    {
    ...
    public ResponseEntity<MovieInfo> getById(@PathVariable("id") long id)
    {
        ...
        return ResponseEntity.of(m_movieService.getById(id));
    }
