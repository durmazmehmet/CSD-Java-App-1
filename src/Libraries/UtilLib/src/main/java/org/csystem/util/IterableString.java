...
public class IterableString implements Serializable, Comparable<String>, CharSequence, Iterable<Character> {
    ...
    public IterableString(char [] chars)
    {
        this(chars, 0, chars.length);
    }

    public IterableString(char[] chars, int offset, int count)
    {
        m_str = new String(chars, offset, count);
    }
    ...
    public IterableString concat(String str)
    {
        return new IterableString(m_str.concat(str));
    }
